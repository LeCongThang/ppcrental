    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="dashboard_graph">
                ...
                @endif
                <div class="col-md-12">
                    <form class="form-horizontal" action="{{URL::asset('')}}admin/update-news-{{$news->id}}" method="post"
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <img id="output" src="{{URL::asset('')}}images/news/{{$news->image}}" width="30%"/>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="tab-content col-lg-offset-2 col-lg-10">
                                    <div id="home" class="tab-pane fade in active">
                                        ...
                                        <textarea rows="8" class="form-control" name="content" required>{{$news->content}}</textarea>
                                    </div>
                                    ...
                                    <div id="menu2" class="tab-pane fade">
                                        ...
                                        <textarea rows="8" class="form-control" name="content_en" required>{{$news->content_en}}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <textarea rows="8" class="form-control" name="seotag" required>{{$news->seotag}}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-lg-2">Show/hide:</label>
                                <div class="col-lg-10">
                                    <input class="form-control" value="1" type="checkbox" @if($news->status==1) checked @endif name="status"/>
                                </div>
                            </div>
