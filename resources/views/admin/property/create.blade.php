    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="dashboard_graph">
                ...
                @endif
                <div class="col-md-12">
                    <form class="form-horizontal" action="{{URL::asset('')}}admin/stored-property" method="post"
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-lg-2">
                                    <select name="property_type" class="form-control">
                                        @foreach($type as $i)
                                            <option value="{{$i->id}}" style="font-weight: bold;">{{$i->name_en}}</option>
                                            <?php
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-2">
                                    <select name="district" id="district" class="form-control" onchange="loadward()" required>
                                ...
                                <div class="col-lg-2">
                                    <select name="ward" id="ward" class="form-control" onchange="getward()" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-2">
                                    <input type="text" class="form-control" name="price" placeholder="ex: $300/spm/month" required/>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-2">
                                    <input type="number" class="form-control" value="1" min="0" name="bedroom"
                                           required/>
                                </div>
                                <label class="control-label col-lg-2">Bath room:</label>
                                <div class="col-lg-2">
                                    <input type="number" class="form-control" value="1" min="0" name="bathroom"
                                           required/>
                                </div>
                                <label class="control-label col-lg-2">Parking place:</label>
                                <div class="col-lg-2">
                                    <input type="number" class="form-control" value="1" min="0" name="parkingplace"
                                           required/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <label class="control-label col-lg-2">Area:</label>
                                <div class="col-lg-2">
                                    <input type="text" class="form-control" name="location" placeholder="ex: 30-50 sqm" required/>
                                </div>
                            </div>
