                ...
                <div class="col-md-9">
                    <div class="panel panel-custom">
                        <div class="panel-body panel-body-custom">
                            ...
                            <h4 style="font-weight:normal;color: #00aeef">{{trans('home.price')}}: {{$p->price}}</h4>
                            ...
                            <p><i class="fa fa-2x fa-tag mauxanh" aria-hidden="true"></i> &nbsp; {{trans('home.propertystatus')}}: @if($p->property_status=1) For Rent @else For Sale @endif</p>
                            <p><i class="fa fa-2x fa-home mauxanh" aria-hidden="true"></i> &nbsp; {{trans('home.propertytype')}}: {{\App\Models\PpcPropertyCategory::find($p->property_type)->name_en}}</p>
                            ...
                            <p><i class="fa fa-2x fa-car mauxanh" aria-hidden="true"></i> &nbsp; {{trans('home.parkingplace')}}: {{$p->parkingplace}}</p>
                            <p><i class="fa fa-2x fa-list-ol mauxanh" aria-hidden="true"></i> &nbsp; {{trans('home.propertyfeature')}}:
                                @foreach($feature as $i)  <u class="mauxanh">{{$i->feature_en.', '}}</u>@endforeach</p>
                            <hr/>
                            <h3><u>{{trans('home.contact')}}:</u></h3>
                            <div class="col-lg-3">
                                <img src="{{URL::asset('')}}images/users/{{$user->avatar}}" class="img-responsive img-circle" style="border:5px solid #75D2F0">
                                <h4 class="text-center">{{$user->fullname}}</h4>
                            </div>
                            <div class="col-lg-9">

                                <p><span class="glyphicon glyphicon-phone mauxanh"></span> {{trans('home.mobile')}}: {{$user->phone}}</p>
                                <p><span class="glyphicon glyphicon-envelope mauxanh"></span> {{trans('home.email')}}: {{$user->email}}
                                </p>
