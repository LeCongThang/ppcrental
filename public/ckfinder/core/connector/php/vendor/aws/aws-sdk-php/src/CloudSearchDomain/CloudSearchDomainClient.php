...
/**
 * This client is used to search.blade.php and upload documents to an **Amazon CloudSearch** Domain.
 *
 * @method \Aws\Result search.blade.php(array $args = [])
...
class CloudSearchDomainClient extends AwsClient
{
    ...
    /**
     * Use POST for search.blade.php command
     *
